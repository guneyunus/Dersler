...
Fultbolcu CenkTosun = new DefansOyuncusu();
CenkTosun.Cinsiyet = true;
CenkTosun.Isim = "Cenk Tosun";
CenkTosun.Yas = new DateTime(1975, 10, 12);

Fultbolcu Ronaldo = new HucumOyuncusu();

Random rnd = new Random();
int randomSayi = rnd.Next(100, 500);

//ternary if
BaseTranslate translate = randomSayi % 2 == 0 ? new GoogleTranslat("Deneme") : new BingTanslate("Eroor", "param");
string aa = translate.Translate("deneme", 10);

GoogleTranslat translateGoogle = new GoogleTranslat("adsad"); 
